...
.x-scroll-bottom {
    ...
    color: #272727;
    border-radius: 100%;
    -webkit-transition: margin-top 0.6s ease,opacity 0.3s ease;
...
@media only screen and (min-width: 280px) and (max-width: 360px){
    #cs-content ul.x-slides {
        margin-left: -344px !important;
    }   
    #cs-content li.x-slide {
...
@media only screen and (min-width: 768px) and (max-width: 820px) {
    #cs-content ul.x-slides {
        margin-left: -393.594px !important;
    }   
    #cs-content li.x-slide {
        width: 393.594px !important;
    }   
}
@media only screen and (min-width: 820px) and (max-width: 912px) {
    #cs-content ul.x-slides {
        margin-left: -437.758px !important;
    }   
    #cs-content li.x-slide {
        width: 437.758px !important;
    }   
}
